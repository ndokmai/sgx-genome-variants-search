...
// Error message for encrypt and decrypt
...
int aescbc_encrypt(unsigned char *plaintext, int plaintext_len, unsigned char *key,
...
int aescbc_decrypt(unsigned char *ciphertext, int ciphertext_len, unsigned char *key,
